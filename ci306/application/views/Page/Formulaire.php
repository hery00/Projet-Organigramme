...
<form action="<?php echo base_url('Form/get_form');?>" method="POST")
    <div class="container">
        ...
        <a href="http://">Agent</a>
        <!-- ---GRILLE D'ANALYSE D'EMPLOYEUR--- -->
        <div class="intitule">Intitulé du poste : <textarea name="message" rows="1" cols="20"></textarea></div>
        <div class="daty">Date :  <textarea name="message" rows="1" cols="20"></textarea></div>
        ...
        <h2>MOYENS DU POSTE</h2> 
            <div class="m">Quels sont les moyens matériels dont vous disposez pour remplir vos fonctions (outils, logiciels,
            fournitures...)</div>
            <textarea name="message" rows="10" cols="90"></textarea> 
        
        <h2>CONDITIONS PARTICULIERES ET CONTRAINTES D’EXERCICE DU POSTE</h2>
            <div class="c">Quelles sont les contraintes (physiques, de temps, d’espace, port EPI etc.) que vous rencontrez dans
            l’exercice de vos fonctions ?</div>
            <textarea name="message" rows="10" cols="90"></textarea> 

        <h2>POUVEZ-VOUS DECRIRE UNE JOURNEE TYPE ?</h2>
            <div class="txt"><textarea name="message" rows="40" cols="100"></textarea> </div>  
