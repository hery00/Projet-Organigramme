...
<form action="<?php echo base_url('poste/load_grille');?>" method="POST")
    <div class="container">
        ...
        <h2>POSITIONNEMENT HIERARCHIQUE</h2>
            ...
            <div class="p2">2. Encadre-t-il- des agents au cours de vos activités ?(Oui/Non)<input type="text" name="" id=""></div>
            <div class="p3">3. Si oui, indiquez le nombre d’agents encadrés : <input type="number" name="nbencadrement" id=""></div>
            <div class="p4">4. A quelle catégorie hiérarchique appartiennent-ils ?(A/B/C)<input type="text" name="categorie" id=""></div>
