...
<form action="<?php echo base_url('poste/load_grille');?>" method="POST")
    ...
    <div class="container">
                ...
                <div class="intitule">Intitulé du poste : <input type="text" name="intitule"> </div>
                <div class="daty">Date :  <input type="date" name="date"></div>
                ...
                <h2>CONDITIONS PARTICULIERES ET CONTRAINTES D’EXERCICE DU POSTE</h2>
                    ...
                    <textarea  rows="10" cols="90" name="contraintes"></textarea> 

                <h2>POUVEZ-VOUS DECRIRE UNE JOURNEE TYPE DE VOTRE AGENT?</h2>
                    <div class="txt"><textarea  rows="40" cols="100" name="description_journee"></textarea > </div>  
</form>  
