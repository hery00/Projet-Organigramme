...
(   
    ...
    intitule_poste varchar(250),
    daty date,
    activites_quotidiens varchar(255),
    activites_semaines varchar(255),
    activites_mois varchar(255),
    activites_an varchar(255),
    activites_missions varchar(255),
    position_suphierarchique varchar(250),
    position_encadrement varchar(250),
    position_nbencadres varchar(250),
    position_categories varchar(255),
    relation_agent varchar(255),
    relation_exterieur varchar(255),
    exigence_professionnelles varchar(255),
    exigence_perso varchar(255),
    exigence_maitrise varchar(255),
    moyen varchar(255),
