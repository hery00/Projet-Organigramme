<?php 
     ...
     class Mgrille extends CI_Model 
    {
          ...
          $exigence_professionnelles, $exigence_perso, $exigence_maitrise, $moyen, $condition, $descri)
        {
            ...
            $requete = "INSERT INTO grille VALUES (DEFAULT, %s,'2022-06-12', %s, %s, %s, %s, %s,
            %s, %s, %s, %s, %s, %s, %s,
            %s, %s, %s, %s, %s)";
            ...
            $this->db->escape($activites_an),
            $this->db->escape($activites_missions),
            $this->db->escape($position_suphierarchique),
            $this->db->escape($position_encadrement),
            $this->db->escape($position_nbencadres),
            $this->db->escape($position_categories),
            $this->db->escape($relation_agent),
            $this->db->escape($relation_exterieur),
            $this->db->escape($exigence_professionnelles),
            $this->db->escape($exigence_perso),
            $this->db->escape($exigence_maitrise),
            $this->db->escape($moyen),
            $this->db->escape($condition),
            $this->db->escape($descri));
